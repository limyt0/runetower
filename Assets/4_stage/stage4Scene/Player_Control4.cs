...
enum jump_state4 { jump, ground }



public class Player_Control4 : MonoBehaviour
{
    ...
    jump_state4 js = jump_state4.ground;
    ...
    void player_jump()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) == true && js == jump_state4.ground)
        {
            print("jump");
    ...
    {
        if (js != jump_state4.ground && collision.gameObject.tag == "ground") js = jump_state4.ground;
        print("지금상태는: " + js);
    }
